...
var SumerianSceneComponent = /** @class */ (function () {
    ...
    SumerianSceneComponent.prototype.loadComponent = function () {
        var sumerianScene = this.framework && this.framework.toLowerCase() === 'ionic' ? new ComponentMount(SumerianSceneComponentIonic, { sceneName: this.sceneName }) : new ComponentMount(SumerianSceneComponentCore, { sceneName: this.sceneName });
