...
var logger = new Logger('SumerianSceneComponentCore');
...
var SumerianSceneComponentCore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, XR.loadScene(this.sceneName, "sumerian-scene-dom-id", sceneOptions)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
                        ...
                        logger.error(this.sceneError, e_1);
                        return [2 /*return*/];
                    case 4:
                        ...
                        XR.onSceneEvent(this.sceneName, 'AudioEnabled', function () { return _this.showEnableAudio = false; });
                        XR.onSceneEvent(this.sceneName, 'AudioDisabled', function () { return _this.showEnableAudio = true; });
                        return [2 /*return*/];
                }
            });
        });
    ...
    SumerianSceneComponentCore.prototype.enterVR = function () {
